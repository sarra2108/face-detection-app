...
(function (factory) {
    ...
    async function loadRoundedRectShape(engine, refresh = true) {
        const { RoundedRectDrawer } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./RoundedRectDrawer.js"))) : new Promise((resolve_1, reject_1) => { require(["./RoundedRectDrawer.js"], resolve_1, reject_1); }).then(__importStar));
