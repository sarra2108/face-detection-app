...
(function (factory) {
    ...
    class PoissonDiscPlugin {
        ...
        async getPlugin(container) {
            const { PoissonInstance } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./PoissonInstance.js"))) : new Promise((resolve_1, reject_1) => { require(["./PoissonInstance.js"], resolve_1, reject_1); }).then(__importStar));
