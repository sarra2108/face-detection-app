...
(function (factory) {
    ...
    async function loadRoundedPolygonShape(engine, refresh = true) {
        const { RoundedPolygonDrawer } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./RoundedPolygonDrawer.js"))) : new Promise((resolve_1, reject_1) => { require(["./RoundedPolygonDrawer.js"], resolve_1, reject_1); }).then(__importStar));
