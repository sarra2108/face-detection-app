...
(this.webpackChunk_tsparticles_all=this.webpackChunk_tsparticles_all||[]).push([[7774],{7774:(a,c,n)=>{n.d(c,{CircleDrawer:()=>s});var e=n(5540);const i=2*Math.PI,t=0,r=0;class s{draw(a){!function(a){const{context:c,particle:n,radius:e}=a;n.circleRange||(n.circleRange={min:0,max:i});const s=n.circleRange;c.arc(t,r,e,s.min,s.max,!1)}(a)}getSidesCount(){return 12}particleInit(a,c){const n=c.shapeData,i=n?.angle??{max:360,min:0};c.circleRange=(0,e.Gv)(i)?{min:(0,e.pu)(i.min),max:(0,e.pu)(i.max)}:{min:0,max:(0,e.pu)(i)}}}}}]);